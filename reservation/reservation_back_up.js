...
function Search(){
  ...
  function objectToDiv(obj,data) {
    ...
    for (const key in obj) {
        ...
        if (value !== "") {
            html += `<a href="../pay/pay.html?${citySelect_1.value}&${city_station_1.value}&${citySelect_2.value}&${city_station_2.value}&${data.train_no}&${data.departs_on}&${data.train_type}&${data.starting_time}&${data.total_time_taken}&${data.distance}&${data.ending_time}&${className}&${value}">
